...
export const renderFullCertAwardText = doc => (
  <div>
    ...
    >
      <span style={arial16Pt}>This is to certify that</span>
    </div>
    <div className="ml-3">
      <div className="mr-3">
        <div className="row d-flex justify-content-center">
    ...
    <div className="row d-flex justify-content-center">
      <span style={arial16Pt}>and attained the prescribed standard was awarded the</span>
    </div>
    ...
    <div className="ml-5">
      <div className="mr-5">
        <div className="row d-flex justify-content-center">
          {!doc.description.includes(" in ") && doc.description.includes("Certificate of Competency") && (
            <span style={timesNewRoman32Pt}>
              <p style={timesNewRoman32Pt}>for</p>
            </span>
          )}
        </div>
      </div>{" "}
